    ...
    <div class="container-fluid">
        <div class="header-body" x-cloak x-data="{totalVendors:{{ $totalVendors }},totalActiveVendors:{{ $totalActiveVendors }},totalCampaigns:{{ $totalCampaigns }},messagesInQueue:{{ $messagesInQueue }},totalContacts:{{ $totalContacts }},totalMessagesProcessed:{{ $totalMessagesProcessed }} }">
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-6 col-md-10 col-sm-6 mb-md-4">
                    <div class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-auto">
                                    <div class="icon icon-shape bg-danger text-white rounded-circle shadow" style="background:white">
                    ...
                    <div class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-auto">
                                    <div class="icon icon-shape bg-danger text-white rounded-circle shadow" style="background-color:white; !important">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="row mb-2">
                        ...
                        {{-- total contacts --}}
                        <div class="col-xl-4 col-lg-6 col-md-10 col-sm-6 mb-md-4">
                            <div class="card card-stats mb-4 mb-xl-0 contact-card">
                                <div class="card-body dash-card">
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <div
                                                class="icon icon-shape text-white rounded-circle shadow" style="background:#008069">
                            ...
                            <div class="card card-stats mb-4 mb-xl-0">
                                <div class="card-body dash-card">
                                    <div class="row" >
                                        ...
                                        <div class="col-auto">
                                            <div class="icon icon-shape text-white rounded-circle shadow" style="background: #008069">
                                                <i class="fas fa-stream text-gray-300"></i>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        @endif
                        @if (hasVendorAccess('messaging'))
                        <div class="col-xl-4 col-xl-4 col-md-6 col-sm-12">
                            <div class="card card-stats mb-4 mb-xl-0">
                                <div class="card-body dash-card">
                                    <div class="row">
                                        <div class="col">
